...
Ангилсан статистик цувааны харьцангуй давтамжийн гистограмыг байгуул.
...
Түүврийн $\sigma$ - дундаж квадрат хазайлт , $D = \sigma^2$ - дисперсийг ол.

`mydata`, `a` - зэрэг нь ажлын талбарт бэлэн байрлаж байгаа.

*** =instructions
- $\sigma_a$ = `sd(a)` а - түүврийн квадрат хазайлтыг олох
- $\sigma_a^2 = D_a$ а - түүврийн дисперси олох

*** =hint
- `sdt(a$V2)`  түүврийн квадрат хазайлтыг олох
- `D <- $\sigma$**2  түүврийн дисперси олох
