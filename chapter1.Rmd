...
**`mydata`** хувсагчийн **1-р багана** $\sqrt 2 \cdot k$ дарааллыг харин **2-р багана** $a\_k$ -г агуулна.

- Өгөгдөлийг дуудаж үзэх: `mydata`
- Эхний болон сүүлчийн 6 элементийг хэсэгчилэн үзэх:
...
- Багананд шинэ нэр олгох:
- `colnames(mydata) <- c("V1","b")`

- Шинэ хувьсагчид утга олгох:
`c <- mydata[2]`, `a <- mydata$b`, `m <- 10`
