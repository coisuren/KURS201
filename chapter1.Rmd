...
*** =instructions
- `mydata` хувсагчийн **1-р багана** $a\_k$-г харин **2-р багана** $frac(a\_k)$-г агуулна.  
- Өгөгдлийн нэрийг дуудаж үзэх:
- `ls()`, `mydata`,
- Эхний 6, сүүлчийн 6 элементийг хэсэгчилэн үзэх:
- `head(mydata)`, 
- `tail(mydata)`,
- Хэмжээс, баганы нэр, багана дээрх утгыг харах:
- `dim(mydata)`,
- `names(mydata)`,
- `mydata$"V2"`,
- `mydata$"V1"`,
