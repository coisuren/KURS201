...
$p(k;n,p) = C_n^k \cdot p^k \cdot q^{n-k}, \quad n=10 $ биномт тархалтын **p** -параметрыг 
туршилтын момент $M_1=\overline{x}=6.8$ -ээр моментын арга хэрэглэн ол.

*** =instructions

- Биномт тархалтын хувьд I эрэмбийн төвийн момент $M_1=\sum_{k=1}^{10} k \cdot C_{10}^{k}\cdot p^k \cdot q^{10-k}=10\cdot p$ тул
- $10p=6.8 \rigtharrow p=0.68.$ гэж параметр олдоно.
