...
**Бодлого 17** -гийн өгөгдөл болон хамгийн бага квадратын аргаар олсон параметруудыг ашиглан $(yk-y)$ хэмжигдэхүүн $N(0,\sqrt{0.1})$ тархалттай болохыг **Уилкоксоны шинжүүрээр** шалга! Энд ${t1, ..., t30}$ загвар түүврээр **t** -г хэрэглэнэ үү.  
