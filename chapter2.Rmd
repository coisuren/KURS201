...
``$x_1 ,\, x_2,\, x_3$`` санамсаргүй хэмжигдэхүүний үл хамаарсан хэмжилтүүд $\tilde{x}1=17,\, \tilde{x}2=81,\, \tilde{x}3=83$  өгөгдөв. Энэ хэмжилтийн алдаануудыг $ N[0, \sigma(k)], \, k =1,2,3$ стандарт нормаль тархалттай гэж үзээд с.х -ний утгыг сайжруул. Энд $x1 + x2 + x3 - 180 = 0 $ хамааралтай ба $ \sigma(i)=1, \quad i=1,2,3 $ байна.
