...
```{tex} 
$x_1, \,x_2, \,x_3$ 
``` гурвалжны өнцгүүдээр авсан санамсаргүй хэмжигдэхүүнүүд. Гурван өнцгийн үл хамаарсан хэмжилтүүд $\tilde{x}1=17^\circ,\, \tilde{x}2=81^\circ,\, \tilde{x}3=83^\circ$  байсан. Гурвалжны дотоод өнцгийн хувьд $x1 + x2 + x3 = 180^\circ$. Тэгвэл хэмжилтийн алдаануудыг $ N[0, \sigma(k)], \, k =1,2,3$ нормаль тархалттай гэж үзээд хэмжилтийн утгуудыг сайжруул. Энд $ \sigma(i)^2 = (0.1^\circ)^2,  \quad i=1,2,3 $  гэж өгөгдөв.
