...
Түүврийг ашиглан $y = a_1$ x + $a_2$  с.х -ний параметрууд $a_1,a_2$ ийг хамгийн бага квадратын аргаар тодорхойл.

Хамгийн их  квадратын аргаар $a_1,a_2$ коеффициентуудыг олохдоо
- $a_1 = \frac{M(xy)-MxMy}{Mx^2-(Mx)^2}$
- $a_2 = n \frac{Mx^2My - Mx M(xy)}{Mx^2-(Mx)^2}$
- $ y = a_1x +a_2$ гэж олдоно.
