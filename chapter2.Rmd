...
$ x1 , x2, x3 $ санамсаргүй хэмжигдэхүүний үл хамаарсан хэмжилтүүд $ x'1=17, x'2=81, x'3=83 $ өгөдөв. Энэ хэмжилтийн алдаануудыг $ N[0, \sigma(k)],  k =1,2,3$ нормаль тархалттай гэж үзээд хэмжигдэхүүний утгыг сайжруул. Энд $ x1+x2+x3-180 = 0 $ хамааралтай ба $ \sigma(i)=1, i=1,2,3 $ байна.
