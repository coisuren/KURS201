...
$N(0,1)$ - нормаль тархалттай с.х -ний $n=10$ ширхэг түүврийн хувьд,
\\[ \sum_1^n x_k =2.35 \\]
\\[ f(x_1,...,x_n)=\left( \frac{x_1+ ... + x_n}{n} - a\right) \qquad (1)\\]
(1) нь $N(0,1)$ - стандарт нормаль тархалттай байдаг байв. Тэгээд **а** - параметрын $p=0.95$ түвшний итгэх завсрыг ол.
