...
![equation](https://s3.amazonaws.com/smt201-16/render16_1)  n=10  биномт тархалтын **p** -параметрыг 
туршилтын момент $ M_1 = \overline{x} $ = 6.8  -ээр моментын арга хэрэглэн ол.

*** =instructions

- Биномт тархалтын хувьд I эрэмбийн төвийн момент 
- $ M_{1}$ = ![equation](https://s3.amazonaws.com/smt201-16/render16_1) = $n \cdot p$  тул
- $ 10 \cdot p = 6.8 \Rightarrow p=0.68 $ гэж параметр олдоно.

*** =hint
# Биномт тархалтын хувьд дараах томъёог ашигла.
- $ M_{1}$ = ![equation](https://s3.amazonaws.com/smt201-16/render16_1) = $n \cdot p$
