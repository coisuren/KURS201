...
$\xi1 ,\, \xi2,\, \xi3$ санамсаргүй хэмжигдэхүүний үл хамаарсан хэмжилтүүд $x1=17,\, x2=81,\, x3=83$  өгөгдөв. Энэ хэмжилтийн алдаануудыг $ N[0, \sigma(k)], \, k =1,2,3$ стандарт нормаль тархалттай гэж үзээд с.х -ний утгыг сайжруул. Энд $ \xi1 + \xi2 + \xi3 - 180 = 0 $ хамааралтай ба $ \sigma(i)=1, \quad i=1,2,3 $ байна.
