...
## 16 Бодлого
$a_k = frac(\sqrt 2 \cdot k), \quad k=\overline{1,200}$
p(k;n,p) = $C_n^k p^k  q^{n-k}$ , n=10  биномт тархалтын **p** -параметрыг 
туршилтын момент $ M_1=\overline{x} $ =6.8 -ээр моментын арга хэрэглэн ол.

*** =instructions

- Биномт тархалтын хувьд I эрэмбийн төвийн момент 
- $ M_1 = \Sigma_{k=1}^{10} k \cdot C_{10}^{k} \cdot$ p^k \cdot q^{10-k} = 10 \cdot p$  тул
